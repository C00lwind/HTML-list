$(function(){
    ...
    function add(){
      ...
      $.each(data,function(i, v){
        $("<tr>").attr("index",i).html("<td contenteditable='true' data-role='name'>" + v.name + "</td>" + "<td contenteditable='true' data-role='address'>" + v.address + "</td>" + "<td contenteditable='true' data-role='mail'>" + v.mail + "</td>" + "<td contenteditable='true' data-role='tel'>" + v.tel+ "</td>"+ "<td contenteditable='true' data-role='qq'>" +v.qq+ "</td>" + "<td><button class='btn btn-danger btn-sm'>删除</button></td>").insertBefore("tr:last");
      })
      saveData(data);
    }
    ...
    $('.btn-sm').click(function(){
        var data = getData();
        data.push({"name": "", "address": "", "mail": "", "tel": ""," qq":""});
        saveData(data);
        add();
